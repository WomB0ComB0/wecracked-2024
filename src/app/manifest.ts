...
export default function manifest(): MetadataRoute.Manifest {
	return {
		...
		short_name: 'BM',
		description:
			'BlogMaven is a versatile and feature-rich blogging platform designed to meet the needs of writers, editors, and readers alike. With its intuitive user interface and robust backend, BlogMaven provides a seamless experience for creating, managing, and engaging with content. Whether you\'re a solo blogger or managing a team of authors, BlogMaven has the tools you need to build a thriving online presence.',
		categories: [
			'blogging',
			'content creation',
			'content management',
		...
		shortcuts: [
			{
				...
				description:
					'Navigate the digital landscape of BlogMaven with ease. Discover our commitment to accessibility.',
				icons: [
					{
			...
			},
			{
				...
				url: '/legal/privacy',
				description:
					'Your privacy matters to us. Learn how BlogMaven protects your personal information.',
				icons: [
					{
						src: '/svgs/logo-icon.svg',
						type: 'image/svg+xml',
